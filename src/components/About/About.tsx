        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -top-8 -left-8 w-32 h-32 bg-yellow-300 dark:bg-yellow-500 rounded-full opacity-20"></div>
              <img
                src="/Home Page Images/10.png"
                alt="Highdorn Properties"
                className="w-full h-96 object-cover rounded-lg shadow-lg"
              />
              <div className="absolute -bottom-8 -right-8 w-24 h-24 bg-blue-400 rounded-full opacity-30"></div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 p-8 hover:shadow-xl dark:hover:shadow-2xl transition-shadow duration-300 group"
              >
                <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-6 group-hover:bg-blue-200 dark:group-hover:bg-blue-800 transition-colors duration-300">
                  <feature.icon className="w-8 h-8 text-blue-900 dark:text-blue-100" />
                </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-white">
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-center gap-2 text-slate-300 hover:text-white cursor-pointer transition-colors">
