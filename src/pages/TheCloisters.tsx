...
const TheCloisters = () => {
  ...
  const features = [
    { icon: Building2, title: '45 Premium Units', description: 'Luxury apartments across 6 floors' },
    { icon: MapPin, title: 'Prime Location', description: 'Endsleigh Gardens, Euston' },
    { icon: Shield, title: '24/7 Concierge', description: 'Professional security and support' },
    { icon: Home, title: 'Period Features', description: 'Historic charm with modern amenities' }
  ];
            ...
            >
              <div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight text-gray-900 dark:text-white mb-6 font-['Inter']">
                  The <span className="text-[#349bff]">Cloisters</span>
                </h1>
              ...
              <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed font-light">
                An elegant residential development featuring 45 premium apartments across 6 floors. Located in the prestigious Endsleigh Gardens area near Euston, this distinguished property offers modern living spaces with period charm in one of London's most sought-after neighborhoods.
              </p>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto font-light">
              Discover the exceptional amenities and features that make The Cloisters a premier residential destination
            </p>
          </motion.div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-rose-50 via-pink-50 to-red-50 dark:bg-gradient-to-br dark:from-navy-900 dark:via-navy-800 dark:to-navy-700">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto font-light">
              Everything you need for comfortable and convenient living in central London
            </p>
          </motion.div>
