...
const Pensions2024 = () => {
  ...
  const pdfDocuments = [
    ...
    },
    {
      ...
      lastUpdated: 'July 2024',
      description: 'Statement detailing how investment principles have been implemented and voting activities undertaken.'
    },
    {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-4xl mx-auto text-purple-100 leading-relaxed">
              Access our pension statements, implementation reports, and investment principles with interactive document viewing
            </p>
          </motion.div>
        </div>
      </section>
